...
const UserProfile = ({ currentUser }) => {
    ...
    const UserDetails = ({ currentUser }) => {
        return(
            <div>
                <div className='bg-white transition-opacity duration-300 p-2 px-3 rounded-lg text-sm font-spotifyMed text-white backdrop-blur-lg bg-opacity-10 absolute right-0 ' >
                    <div>
                        {currentUser.email}
                    </div>
                </div>
